...
public class SurveyQTen  extends Activity implements View.OnClickListener{
...
RelativeLayout relativeLayout;
        public void onCreate(Bundle savedInstance) {
            ...
            setContentView(R.layout.layout_survey_q10);
        ...
        public void onClick(View view) {
            if( view.getId() == R.id.layout_button  || view.getId()==R.id.button2 || view.getId()==R.id.button3||view.getId()==R.id.button4 ||view.getId()==R.id.button5||view.getId()== R.id.button6) {
...
// Set a delay or duration for the highlight effect (optional)
                ...
                handler.postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        value1Button.setBackground(ContextCompat.getDrawable(SurveyQTen.this, R.drawable.layout_white_background));
