...
public class SurveyQTwo extends Activity implements View.OnClickListener{
    ...
    RelativeLayout relativeLayout;
        ...
        public void onClick(View view) {
            if( view.getId() == R.id.layout_button || view.getId()==R.id.button1 || view.getId()==R.id.button2 || view.getId()==R.id.button3||view.getId()==R.id.button4 ||view.getId()== R.id.button6) {
                value5Button.setBackground(ContextCompat.getDrawable(this, R.drawable.layout_select_button));
...
// Set a delay or duration for the highlight effect (optional)
                ...
                handler.postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        value5Button.setBackground(ContextCompat.getDrawable(SurveyQTwo.this, R.drawable.layout_white_background));
