...
public class SurveyQSeven extends Activity implements View.OnClickListener{
...
RelativeLayout relativeLayout;
        public void onCreate(Bundle savedInstance) {
            ...
            setContentView(R.layout.layout_survey_q7);
...
// Set a delay or duration for the highlight effect (optional)
                ...
                handler.postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        value1Button.setBackground(ContextCompat.getDrawable(SurveyQSeven.this, R.drawable.ic_thumb_up_24));
